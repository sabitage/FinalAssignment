...
THREE.TrackballControls = function ( object, domElement, delegate ) {
	...
	this.handleRemoteEvent = 
	  function (value)
	    {
      // Denormalize things.
      _this.target.x = value.target.x * _this.screen.width;
      _this.target.y = value.target.y * _this.screen.height;
      _this.target.z = value.target.z;

      _this.object.position.x = value.position.x * _this.screen.width;
      _this.object.position.y = value.position.y * _this.screen.height;
      _this.object.position.z = value.position.z;
      
      _this.object.up.x = value.up.x * _this.screen.width;
      _this.object.up.y = value.up.y * _this.screen.height;
      _this.object.up.z = value.up.z;
    ...
    // If I have a delegate, send the new position.
    if(_this.delegate)
      {
      // Not so fast. First I need to normalize things.
      var normalTarget = 
        new THREE.Vector3(
          _this.target.x / _this.screen.width,
          _this.target.y / _this.screen.height,
          _this.target.z);

      var normalPosition = 
        new THREE.Vector3(
          _this.object.position.x / _this.screen.width,
          _this.object.position.y / _this.screen.height,
          _this.object.position.z);
          
      var normalUp = 
        new THREE.Vector3(
          _this.object.up.x / _this.screen.width,
          _this.object.up.y / _this.screen.height,
          _this.object.up.z);
